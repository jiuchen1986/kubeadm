...
etcd:
  local:
    extraArgs:
      ...
      initial-cluster: "{{ hostvars[groups['master'][0]]['ansible_hostname'] }}=https://{{ groups['master'][0] }}:2380,{{ hostvars[groups['master'][1]]['ansible_hostname'] }}=https://{{ groups['master'][1] }}:2380,{{ ansible_hostname }}=https://{{ inventory_hostname }}:2380"
